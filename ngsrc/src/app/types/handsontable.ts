declare namespace _Handsontable {
    ...
    class Core {
        ...
        alter(action: "insert_row" | "insert_col" | "remove_row" | "remove_col",
            index?: number | Array<[number, number]>, amount?: number, source?: string, keepEmptyRows?: boolean): void;
        clear(): void;
        colOffset(): number;
        ...
        populateFromArray(row: number, col: number, input: any[], endRow?: number, endCol?: number,
            source?: string, method?: string, direction?: string, deltas?: any[]): any;
        ...
        selectCells(coords: Array<[number, number | string, number, number | string]> | Array<Handsontable.wot.CellRange>,
            scrollToCell?: boolean, changeListener?: boolean): boolean;
...
declare namespace Handsontable {
    ...
    namespace _editors {
        ...
        class Base {
            ...
            constructor(hotInstance: _Handsontable.Core, row: number,
                col: number, prop: string | number, TD: HTMLElement, cellProperties: GridSettings)
            ...
            isWaiting(): boolean;
            open(): void;
            prepare(row: number, col: number, prop: string | number,
                TD: HTMLElement, originalValue: any, cellProperties: GridSettings): void;
    ...
    namespace plugins {
        ...
        interface RangeType { startRow: number; startCol: number; endRow: number; endCol: number; }
        ...
        interface GanttChart extends Base {
            ...
            uniformBackgroundRenderer(instance: _Handsontable.Core, TD: HTMLElement, row: number,
                col: number, prop: string | number, value: string | number, cellProperties: GridSettings): void;
        ...
        namespace MergeCellsPlugin {
            interface AutofillCalculations {
                ...
                snapDragArea(baseArea: number[], dragArea: number[], dragDirection: string,
                    foundMergedCells: MergeCellsPlugin.MergedCellCoords[]): number[];
        ...
        interface MultipleSelectionHandles extends Base {
            ...
            getCurrentRangeCoords(selectedRange: wot.CellRange, currentTouch: wot.CellCoords,
                touchStartDirection: string, currentDirection: string, draggedHandle: string): object;
            isDragged(): boolean;
        }
    ...
    namespace renderers {
        type Base = (instance: _Handsontable.Core, TD: HTMLElement, row: number, col: number, prop: string | number,
            value: any, cellProperties: GridSettings) => HTMLElement;
    ...
    interface Hooks {
        ...
        afterSelectionByProp?: (r: number, p: string, r2: number,
            p2: string, preventScrolling: object, selectionLayerLevel: number) => void;
        ...
        beforeRenderer?: (TD: Element, row: number, col: number,
            prop: string | number, value: string, cellProperties: GridSettings) => void;
    ...
    namespace I18n {
        ...
        interface Internationalization {
            ...
            registerLanguageDictionary: (languageCodeOrDictionary: LanguageDictionary | string,
    ...
    interface Helper {
        ...
        arrayReduce(array: any[], iteratee: (value: any, index: number, array: any[]) => void,
            accumulator: any, initFromArray: boolean): any;
